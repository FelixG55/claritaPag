      ...
      <div className='footer'>
        ...
        <div className='footer-quiensoy  width-cont'>
          <div className='contact-info'>
            ...
            <h3><FontAwesomeIcon icon={faEnvelope} beat size="xl" style={{color: "#003c56",}} /> claritaeducacionconamor67@gmail.com</h3>
          </div>
          <div className='contact-info-write'>
            ...
            <input type="text" placeholder='Escribenos' id='escribenos'/>
          </div>
        </div>
